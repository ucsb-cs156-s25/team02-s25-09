  ...
  "node_modules/jsdoc-type-pratt-parser/dist/index.js"(exports, module2) {
    (function(global2, factory) {
      ...
      function getNumber(text) {
        var _a2, _b;
        return (_b = (_a2 = numberRegex.exec(text)) === null || _a2 === void 0 ? void 0 : _a2[0]) !== null && _b !== void 0 ? _b : null;
      }
      ...
      function assertNumberOrVariadicNameResult(result) {
        ...
        if (result.type === "JsdocTypeVariadic") {
          if (((_a2 = result.element) === null || _a2 === void 0 ? void 0 : _a2.type) === "JsdocTypeName") {
            return result;
          }
          throw new UnexpectedTypeError(result);
        }
      ...
      function createNamePathParslet({ allowSquareBracketsOnAnyType, allowJsdocNamePaths, pathGrammar: pathGrammar2 }) {
        return function namePathParslet(parser, precedence, left) {
          ...
          const pathParser = pathGrammar2 !== null ? new Parser2(pathGrammar2, parser.lexer, parser) : parser;
      ...
      function createSpecialNamePathParslet({ pathGrammar: pathGrammar2, allowedTypes }) {
        return composeParslet({
          ...
          parsePrefix: (parser) => {
            ...
            const moduleParser = new Parser2(pathGrammar2, parser.lexer, parser);
      ...
      function getParameters(value) {
        ...
        if (value.type === "JsdocTypeParameterList") {
          parameters3 = value.elements;
        } else if (value.type === "JsdocTypeParenthesis") {
          parameters3 = [value.element];
        } else {
          throw new UnexpectedTypeError(value);
        }
        return parameters3.map((p) => assertPlainKeyValueOrRootResult(p));
      }
      function getUnnamedParameters(value) {
        const parameters3 = getParameters(value);
        if (parameters3.some((p) => p.type === "JsdocTypeKeyValue")) {
      ...
      function createObjectParslet({ objectFieldGrammar: objectFieldGrammar2, allowKeyTypes }) {
        return composeParslet({
          ...
          parsePrefix: (parser) => {
            ...
            if (!parser.consume("}")) {
              let separator;
              const fieldParser = new Parser2(objectFieldGrammar2, parser.lexer, parser);
              while (true) {
      ...
      function createObjectFieldParslet({ allowSquaredProperties, allowKeyTypes, allowReadonly, allowOptional }) {
        return composeParslet({
          ...
          parseInfix: (parser, left) => {
            ...
            const parentParser = (_a2 = parser.baseParser) !== null && _a2 !== void 0 ? _a2 : parser;
...
var require_constants = __commonJS2({ "../../node_modules/semver/internal/constants.js"(exports, module2) {
  ...
  module2.exports = { MAX_LENGTH: 256, MAX_SAFE_COMPONENT_LENGTH, MAX_SAFE_BUILD_LENGTH, MAX_SAFE_INTEGER, RELEASE_TYPES, SEMVER_SPEC_VERSION, FLAG_INCLUDE_PRERELEASE: 1, FLAG_LOOSE: 2 };
} });
var require_debug = __commonJS2({ "../../node_modules/semver/internal/debug.js"(exports, module2) {
  var debug = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...args) => console.error("SEMVER", ...args) : () => {
  };
  module2.exports = debug;
} });
var require_re = __commonJS2({ "../../node_modules/semver/internal/re.js"(exports, module2) {
  var { MAX_SAFE_COMPONENT_LENGTH, MAX_SAFE_BUILD_LENGTH, MAX_LENGTH } = require_constants(), debug = require_debug();
  exports = module2.exports = {};
  var re2 = exports.re = [], safeRe = exports.safeRe = [], src = exports.src = [], safeSrc = exports.safeSrc = [], t = exports.t = {}, R2 = 0, LETTERDASHNUMBER = "[a-zA-Z0-9-]", safeRegexReplacements = [["\\s", 1], ["\\d", MAX_LENGTH], [LETTERDASHNUMBER, MAX_SAFE_BUILD_LENGTH]], makeSafeRegex = (value) => {
    ...
    debug(name, index, value), t[name] = index, src[index] = value, safeSrc[index] = safe, re2[index] = new RegExp(value, isGlobal ? "g" : void 0), safeRe[index] = new RegExp(safe, isGlobal ? "g" : void 0);
  };
...
var require_parse_options = __commonJS2({ "../../node_modules/semver/internal/parse-options.js"(exports, module2) {
...
var require_identifiers = __commonJS2({ "../../node_modules/semver/internal/identifiers.js"(exports, module2) {
  ...
  module2.exports = { compareIdentifiers, rcompareIdentifiers };
} });
var require_semver = __commonJS2({ "../../node_modules/semver/classes/semver.js"(exports, module2) {
  var debug = require_debug(), { MAX_LENGTH, MAX_SAFE_INTEGER } = require_constants(), { safeRe: re2, safeSrc: src, t } = require_re(), parseOptions = require_parse_options(), { compareIdentifiers } = require_identifiers(), SemVer = class _SemVer {
    constructor(version22, options) {
      if (options = parseOptions(options), version22 instanceof _SemVer) {
        if (version22.loose === !!options.loose && version22.includePrerelease === !!options.includePrerelease) return version22;
        version22 = version22.version;
      } else if (typeof version22 != "string") throw new TypeError(`Invalid version. Must be a string. Got type "${typeof version22}".`);
      if (version22.length > MAX_LENGTH) throw new TypeError(`version is longer than ${MAX_LENGTH} characters`);
      debug("SemVer", version22, options), this.options = options, this.loose = !!options.loose, this.includePrerelease = !!options.includePrerelease;
      let m = version22.trim().match(options.loose ? re2[t.LOOSE] : re2[t.FULL]);
      if (!m) throw new TypeError(`Invalid Version: ${version22}`);
      if (this.raw = version22, this.major = +m[1], this.minor = +m[2], this.patch = +m[3], this.major > MAX_SAFE_INTEGER || this.major < 0) throw new TypeError("Invalid major version");
    ...
    comparePre(other) {
      ...
      let i = 0;
      do {
        let a = this.prerelease[i], b2 = other.prerelease[i];
        if (debug("prerelease compare", i, a, b2), a === void 0 && b2 === void 0) return 0;
    ...
    compareBuild(other) {
      ...
      let i = 0;
      do {
        let a = this.build[i], b2 = other.build[i];
        if (debug("build compare", i, a, b2), a === void 0 && b2 === void 0) return 0;
        if (b2 === void 0) return 1;
        if (a === void 0) return -1;
        if (a === b2) continue;
        return compareIdentifiers(a, b2);
    ...
    inc(release, identifier, identifierBase) {
      ...
      switch (release) {
        ...
        case "pre": {
          ...
          if (this.prerelease.length === 0) this.prerelease = [base2];
          else {
...
var require_parse = __commonJS2({ "../../node_modules/semver/functions/parse.js"(exports, module2) {
  var SemVer = require_semver(), parse = (version22, options, throwErrors = false) => {
    if (version22 instanceof SemVer) return version22;
    try {
...
var require_valid = __commonJS2({ "../../node_modules/semver/functions/valid.js"(exports, module2) {
  var parse = require_parse(), valid = (version22, options) => {
    let v2 = parse(version22, options);
    return v2 ? v2.version : null;
  };
  module2.exports = valid;
} });
var require_clean = __commonJS2({ "../../node_modules/semver/functions/clean.js"(exports, module2) {
  var parse = require_parse(), clean = (version22, options) => {
    let s2 = parse(version22.trim().replace(/^[=v]+/, ""), options);
    return s2 ? s2.version : null;
  };
  module2.exports = clean;
} });
var require_inc = __commonJS2({ "../../node_modules/semver/functions/inc.js"(exports, module2) {
  var SemVer = require_semver(), inc = (version22, release, options, identifier, identifierBase) => {
    typeof options == "string" && (identifierBase = identifier, identifier = options, options = void 0);
    try {
      return new SemVer(version22 instanceof SemVer ? version22.version : version22, options).inc(release, identifier, identifierBase).version;
    } catch {
      return null;
    }
  };
...
var require_diff = __commonJS2({ "../../node_modules/semver/functions/diff.js"(exports, module2) {
  var parse = require_parse(), diff = (version1, version22) => {
    let v1 = parse(version1, null, true), v2 = parse(version22, null, true), comparison = v1.compare(v2);
...
var require_major = __commonJS2({ "../../node_modules/semver/functions/major.js"(exports, module2) {
  var SemVer = require_semver(), major = (a, loose) => new SemVer(a, loose).major;
  module2.exports = major;
} });
var require_minor = __commonJS2({ "../../node_modules/semver/functions/minor.js"(exports, module2) {
  var SemVer = require_semver(), minor = (a, loose) => new SemVer(a, loose).minor;
  module2.exports = minor;
} });
var require_patch = __commonJS2({ "../../node_modules/semver/functions/patch.js"(exports, module2) {
  var SemVer = require_semver(), patch = (a, loose) => new SemVer(a, loose).patch;
  module2.exports = patch;
} });
var require_prerelease = __commonJS2({ "../../node_modules/semver/functions/prerelease.js"(exports, module2) {
  var parse = require_parse(), prerelease = (version22, options) => {
    let parsed = parse(version22, options);
    return parsed && parsed.prerelease.length ? parsed.prerelease : null;
  };
  module2.exports = prerelease;
} });
var require_compare = __commonJS2({ "../../node_modules/semver/functions/compare.js"(exports, module2) {
  var SemVer = require_semver(), compare = (a, b2, loose) => new SemVer(a, loose).compare(new SemVer(b2, loose));
  module2.exports = compare;
} });
var require_rcompare = __commonJS2({ "../../node_modules/semver/functions/rcompare.js"(exports, module2) {
  var compare = require_compare(), rcompare = (a, b2, loose) => compare(b2, a, loose);
  module2.exports = rcompare;
} });
var require_compare_loose = __commonJS2({ "../../node_modules/semver/functions/compare-loose.js"(exports, module2) {
  var compare = require_compare(), compareLoose = (a, b2) => compare(a, b2, true);
  module2.exports = compareLoose;
} });
var require_compare_build = __commonJS2({ "../../node_modules/semver/functions/compare-build.js"(exports, module2) {
...
var require_sort = __commonJS2({ "../../node_modules/semver/functions/sort.js"(exports, module2) {
  var compareBuild = require_compare_build(), sort = (list, loose) => list.sort((a, b2) => compareBuild(a, b2, loose));
  module2.exports = sort;
} });
var require_rsort = __commonJS2({ "../../node_modules/semver/functions/rsort.js"(exports, module2) {
  var compareBuild = require_compare_build(), rsort = (list, loose) => list.sort((a, b2) => compareBuild(b2, a, loose));
  module2.exports = rsort;
} });
var require_gt = __commonJS2({ "../../node_modules/semver/functions/gt.js"(exports, module2) {
  var compare = require_compare(), gt2 = (a, b2, loose) => compare(a, b2, loose) > 0;
  module2.exports = gt2;
} });
var require_lt = __commonJS2({ "../../node_modules/semver/functions/lt.js"(exports, module2) {
  var compare = require_compare(), lt2 = (a, b2, loose) => compare(a, b2, loose) < 0;
  module2.exports = lt2;
} });
var require_eq = __commonJS2({ "../../node_modules/semver/functions/eq.js"(exports, module2) {
  var compare = require_compare(), eq = (a, b2, loose) => compare(a, b2, loose) === 0;
  module2.exports = eq;
} });
var require_neq = __commonJS2({ "../../node_modules/semver/functions/neq.js"(exports, module2) {
  var compare = require_compare(), neq = (a, b2, loose) => compare(a, b2, loose) !== 0;
  module2.exports = neq;
} });
var require_gte = __commonJS2({ "../../node_modules/semver/functions/gte.js"(exports, module2) {
  var compare = require_compare(), gte = (a, b2, loose) => compare(a, b2, loose) >= 0;
  module2.exports = gte;
} });
var require_lte = __commonJS2({ "../../node_modules/semver/functions/lte.js"(exports, module2) {
  var compare = require_compare(), lte = (a, b2, loose) => compare(a, b2, loose) <= 0;
  module2.exports = lte;
} });
var require_cmp = __commonJS2({ "../../node_modules/semver/functions/cmp.js"(exports, module2) {
  var eq = require_eq(), neq = require_neq(), gt2 = require_gt(), gte = require_gte(), lt2 = require_lt(), lte = require_lte(), cmp = (a, op, b2, loose) => {
    switch (op) {
      case "===":
...
var require_coerce = __commonJS2({ "../../node_modules/semver/functions/coerce.js"(exports, module2) {
  var SemVer = require_semver(), parse = require_parse(), { safeRe: re2, t } = require_re(), coerce = (version22, options) => {
    if (version22 instanceof SemVer) return version22;
    if (typeof version22 == "number" && (version22 = String(version22)), typeof version22 != "string") return null;
    options = options || {};
    let match = null;
    if (!options.rtl) match = version22.match(options.includePrerelease ? re2[t.COERCEFULL] : re2[t.COERCE]);
    else {
      let coerceRtlRegex = options.includePrerelease ? re2[t.COERCERTLFULL] : re2[t.COERCERTL], next;
      for (; (next = coerceRtlRegex.exec(version22)) && (!match || match.index + match[0].length !== version22.length); ) (!match || next.index + next[0].length !== match.index + match[0].length) && (match = next), coerceRtlRegex.lastIndex = next.index + next[1].length + next[2].length;
...
var require_lrucache = __commonJS2({ "../../node_modules/semver/internal/lrucache.js"(exports, module2) {
  var LRUCache = class {
    constructor() {
...
var require_range = __commonJS2({ "../../node_modules/semver/classes/range.js"(exports, module2) {
  var SPACE_CHARACTERS = /\s+/g, Range = class _Range {
    ...
    test(version22) {
      if (!version22) return false;
      if (typeof version22 == "string") try {
        version22 = new SemVer(version22, this.options);
      } catch {
        return false;
      }
      for (let i = 0; i < this.set.length; i++) if (testSet(this.set[i], version22, this.options)) return true;
      return false;
    }
  };
  module2.exports = Range;
  var LRU = require_lrucache(), cache = new LRU(), parseOptions = require_parse_options(), Comparator = require_comparator(), debug = require_debug(), SemVer = require_semver(), { safeRe: re2, t, comparatorTrimReplace, tildeTrimReplace, caretTrimReplace } = require_re(), { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = require_constants(), isNullSet = (c) => c.value === "<0.0.0-0", isAny = (c) => c.value === "", isSatisfiable = (comparators, options) => {
    ...
    let r = options.loose ? re2[t.TILDELOOSE] : re2[t.TILDE];
    return comp.replace(r, (_, M3, m, p, pr) => {
      debug("tilde", comp, _, M3, m, p, pr);
      let ret;
      return isX(M3) ? ret = "" : isX(m) ? ret = `>=${M3}.0.0 <${+M3 + 1}.0.0-0` : isX(p) ? ret = `>=${M3}.${m}.0 <${M3}.${+m + 1}.0-0` : pr ? (debug("replaceTilde pr", pr), ret = `>=${M3}.${m}.${p}-${pr} <${M3}.${+m + 1}.0-0`) : ret = `>=${M3}.${m}.${p} <${M3}.${+m + 1}.0-0`, debug("tilde return", ret), ret;
    });
  }, replaceCarets = (comp, options) => comp.trim().split(/\s+/).map((c) => replaceCaret(c, options)).join(" "), replaceCaret = (comp, options) => {
    debug("caret", comp, options);
    let r = options.loose ? re2[t.CARETLOOSE] : re2[t.CARET], z2 = options.includePrerelease ? "-0" : "";
    return comp.replace(r, (_, M3, m, p, pr) => {
      debug("caret", comp, _, M3, m, p, pr);
      let ret;
      return isX(M3) ? ret = "" : isX(m) ? ret = `>=${M3}.0.0${z2} <${+M3 + 1}.0.0-0` : isX(p) ? M3 === "0" ? ret = `>=${M3}.${m}.0${z2} <${M3}.${+m + 1}.0-0` : ret = `>=${M3}.${m}.0${z2} <${+M3 + 1}.0.0-0` : pr ? (debug("replaceCaret pr", pr), M3 === "0" ? m === "0" ? ret = `>=${M3}.${m}.${p}-${pr} <${M3}.${m}.${+p + 1}-0` : ret = `>=${M3}.${m}.${p}-${pr} <${M3}.${+m + 1}.0-0` : ret = `>=${M3}.${m}.${p}-${pr} <${+M3 + 1}.0.0-0`) : (debug("no pr"), M3 === "0" ? m === "0" ? ret = `>=${M3}.${m}.${p}${z2} <${M3}.${m}.${+p + 1}-0` : ret = `>=${M3}.${m}.${p}${z2} <${M3}.${+m + 1}.0-0` : ret = `>=${M3}.${m}.${p} <${+M3 + 1}.0.0-0`), debug("caret return", ret), ret;
    });
    ...
    comp = comp.trim();
    let r = options.loose ? re2[t.XRANGELOOSE] : re2[t.XRANGE];
    return comp.replace(r, (ret, gtlt, M3, m, p, pr) => {
      debug("xRange", comp, ret, gtlt, M3, m, p, pr);
      let xM = isX(M3), xm = xM || isX(m), xp = xm || isX(p), anyX = xp;
      return gtlt === "=" && anyX && (gtlt = ""), pr = options.includePrerelease ? "-0" : "", xM ? gtlt === ">" || gtlt === "<" ? ret = "<0.0.0-0" : ret = "*" : gtlt && anyX ? (xm && (m = 0), p = 0, gtlt === ">" ? (gtlt = ">=", xm ? (M3 = +M3 + 1, m = 0, p = 0) : (m = +m + 1, p = 0)) : gtlt === "<=" && (gtlt = "<", xm ? M3 = +M3 + 1 : m = +m + 1), gtlt === "<" && (pr = "-0"), ret = `${gtlt + M3}.${m}.${p}${pr}`) : xm ? ret = `>=${M3}.0.0${pr} <${+M3 + 1}.0.0-0` : xp && (ret = `>=${M3}.${m}.0${pr} <${M3}.${+m + 1}.0-0`), debug("xRange return", ret), ret;
    });
  }, replaceStars = (comp, options) => (debug("replaceStars", comp, options), comp.trim().replace(re2[t.STAR], "")), replaceGTE0 = (comp, options) => (debug("replaceGTE0", comp, options), comp.trim().replace(re2[options.includePrerelease ? t.GTE0PRE : t.GTE0], "")), hyphenReplace = (incPr) => ($0, from, fM, fm, fp, fpr, fb, to, tM, tm, tp, tpr) => (isX(fM) ? from = "" : isX(fm) ? from = `>=${fM}.0.0${incPr ? "-0" : ""}` : isX(fp) ? from = `>=${fM}.${fm}.0${incPr ? "-0" : ""}` : fpr ? from = `>=${from}` : from = `>=${from}${incPr ? "-0" : ""}`, isX(tM) ? to = "" : isX(tm) ? to = `<${+tM + 1}.0.0-0` : isX(tp) ? to = `<${tM}.${+tm + 1}.0-0` : tpr ? to = `<=${tM}.${tm}.${tp}-${tpr}` : incPr ? to = `<${tM}.${tm}.${+tp + 1}-0` : to = `<=${to}`, `${from} ${to}`.trim()), testSet = (set, version22, options) => {
    for (let i = 0; i < set.length; i++) if (!set[i].test(version22)) return false;
    if (version22.prerelease.length && !options.includePrerelease) {
      for (let i = 0; i < set.length; i++) if (debug(set[i].semver), set[i].semver !== Comparator.ANY && set[i].semver.prerelease.length > 0) {
        ...
        if (allowed.major === version22.major && allowed.minor === version22.minor && allowed.patch === version22.patch) return true;
      }
      return false;
    }
    return true;
...
var require_comparator = __commonJS2({ "../../node_modules/semver/classes/comparator.js"(exports, module2) {
  var ANY = Symbol("SemVer ANY"), Comparator = class _Comparator {
    ...
    parse(comp) {
      let r = this.options.loose ? re2[t.COMPARATORLOOSE] : re2[t.COMPARATOR], m = comp.match(r);
    ...
    test(version22) {
      if (debug("Comparator.test", version22, this.options.loose), this.semver === ANY || version22 === ANY) return true;
      if (typeof version22 == "string") try {
        version22 = new SemVer(version22, this.options);
      } catch {
        return false;
...
var require_satisfies = __commonJS2({ "../../node_modules/semver/functions/satisfies.js"(exports, module2) {
  var Range = require_range(), satisfies = (version22, range, options) => {
    try {
...
var require_to_comparators = __commonJS2({ "../../node_modules/semver/ranges/to-comparators.js"(exports, module2) {
...
var require_max_satisfying = __commonJS2({ "../../node_modules/semver/ranges/max-satisfying.js"(exports, module2) {
...
var require_min_satisfying = __commonJS2({ "../../node_modules/semver/ranges/min-satisfying.js"(exports, module2) {
...
var require_min_version = __commonJS2({ "../../node_modules/semver/ranges/min-version.js"(exports, module2) {
  var SemVer = require_semver(), Range = require_range(), gt2 = require_gt(), minVersion = (range, loose) => {
...
var require_valid2 = __commonJS2({ "../../node_modules/semver/ranges/valid.js"(exports, module2) {
...
var require_outside = __commonJS2({ "../../node_modules/semver/ranges/outside.js"(exports, module2) {
  var SemVer = require_semver(), Comparator = require_comparator(), { ANY } = Comparator, Range = require_range(), satisfies = require_satisfies(), gt2 = require_gt(), lt2 = require_lt(), lte = require_lte(), gte = require_gte(), outside = (version22, range, hilo, options) => {
    version22 = new SemVer(version22, options), range = new Range(range, options);
    let gtfn, ltefn, ltfn, comp, ecomp;
    switch (hilo) {
      case ">":
        gtfn = gt2, ltefn = lte, ltfn = lt2, comp = ">", ecomp = ">=";
        break;
      case "<":
        gtfn = lt2, ltefn = gte, ltfn = gt2, comp = "<", ecomp = "<=";
        break;
      default:
        throw new TypeError('Must provide a hilo val of "<" or ">"');
    }
    if (satisfies(version22, range, options)) return false;
    for (let i = 0; i < range.set.length; ++i) {
      let comparators = range.set[i], high = null, low = null;
      if (comparators.forEach((comparator) => {
        comparator.semver === ANY && (comparator = new Comparator(">=0.0.0")), high = high || comparator, low = low || comparator, gtfn(comparator.semver, high.semver, options) ? high = comparator : ltfn(comparator.semver, low.semver, options) && (low = comparator);
      }), high.operator === comp || high.operator === ecomp || (!low.operator || low.operator === comp) && ltefn(version22, low.semver)) return false;
      if (low.operator === ecomp && ltfn(version22, low.semver)) return false;
    }
    return true;
  };
  module2.exports = outside;
} });
var require_gtr = __commonJS2({ "../../node_modules/semver/ranges/gtr.js"(exports, module2) {
  var outside = require_outside(), gtr = (version22, range, options) => outside(version22, range, ">", options);
  module2.exports = gtr;
} });
var require_ltr = __commonJS2({ "../../node_modules/semver/ranges/ltr.js"(exports, module2) {
  var outside = require_outside(), ltr = (version22, range, options) => outside(version22, range, "<", options);
  module2.exports = ltr;
} });
var require_intersects = __commonJS2({ "../../node_modules/semver/ranges/intersects.js"(exports, module2) {
...
var require_simplify = __commonJS2({ "../../node_modules/semver/ranges/simplify.js"(exports, module2) {
  var satisfies = require_satisfies(), compare = require_compare();
  module2.exports = (versions, range, options) => {
    let set = [], first = null, prev = null, v2 = versions.sort((a, b2) => compare(a, b2, options));
    for (let version22 of v2) satisfies(version22, range, options) ? (prev = version22, first || (first = version22)) : (prev && set.push([first, prev]), prev = null, first = null);
...
var require_subset = __commonJS2({ "../../node_modules/semver/ranges/subset.js"(exports, module2) {
  var Range = require_range(), Comparator = require_comparator(), { ANY } = Comparator, satisfies = require_satisfies(), compare = require_compare(), subset = (sub, dom, options = {}) => {
    ...
    let eqSet = /* @__PURE__ */ new Set(), gt2, lt2;
    for (let c of sub) c.operator === ">" || c.operator === ">=" ? gt2 = higherGT(gt2, c, options) : c.operator === "<" || c.operator === "<=" ? lt2 = lowerLT(lt2, c, options) : eqSet.add(c.semver);
    if (eqSet.size > 1) return null;
    let gtltComp;
    if (gt2 && lt2) {
      if (gtltComp = compare(gt2.semver, lt2.semver, options), gtltComp > 0) return null;
      if (gtltComp === 0 && (gt2.operator !== ">=" || lt2.operator !== "<=")) return null;
    }
    for (let eq of eqSet) {
      if (gt2 && !satisfies(eq, String(gt2), options) || lt2 && !satisfies(eq, String(lt2), options)) return null;
      for (let c of dom) if (!satisfies(eq, String(c), options)) return false;
      return true;
    }
    let higher, lower, hasDomLT, hasDomGT, needDomLTPre = lt2 && !options.includePrerelease && lt2.semver.prerelease.length ? lt2.semver : false, needDomGTPre = gt2 && !options.includePrerelease && gt2.semver.prerelease.length ? gt2.semver : false;
    ...
    for (let c of dom) {
      if (hasDomGT = hasDomGT || c.operator === ">" || c.operator === ">=", hasDomLT = hasDomLT || c.operator === "<" || c.operator === "<=", gt2) {
        if (needDomGTPre && c.semver.prerelease && c.semver.prerelease.length && c.semver.major === needDomGTPre.major && c.semver.minor === needDomGTPre.minor && c.semver.patch === needDomGTPre.patch && (needDomGTPre = false), c.operator === ">" || c.operator === ">=") {
          if (higher = higherGT(gt2, c, options), higher === c && higher !== gt2) return false;
        } else if (gt2.operator === ">=" && !satisfies(gt2.semver, String(c), options)) return false;
      }
      if (lt2) {
        if (needDomLTPre && c.semver.prerelease && c.semver.prerelease.length && c.semver.major === needDomLTPre.major && c.semver.minor === needDomLTPre.minor && c.semver.patch === needDomLTPre.patch && (needDomLTPre = false), c.operator === "<" || c.operator === "<=") {
          if (lower = lowerLT(lt2, c, options), lower === c && lower !== lt2) return false;
        } else if (lt2.operator === "<=" && !satisfies(lt2.semver, String(c), options)) return false;
      }
      if (!c.operator && (lt2 || gt2) && gtltComp !== 0) return false;
    }
...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    reactAct = ((_a2 = deprecatedTestUtils == null ? void 0 : deprecatedTestUtils.default) == null ? void 0 : _a2.act) ?? deprecatedTestUtils.act;
  }
  ...
  return await new Promise(async (resolve, reject) => {
    actQueue.push(async () => {
      try {
        await act(async () => {
          var _a2, _b;
          await renderElement(element, canvasElement, (_b = (_a2 = storyContext == null ? void 0 : storyContext.parameters) == null ? void 0 : _a2.react) == null ? void 0 : _b.rootOptions);
        }), resolve();
      } catch (e) {
        reject(e);
      }
...
var decorators = [(story, context) => {
  var _a2, _b;
  if (!((_b = (_a2 = context.parameters) == null ? void 0 : _a2.react) == null ? void 0 : _b.rsc)) return story();
...
var Pe = o((e) => {
  switch (e.type) {
    ...
    default:
      throw new Z({ type: e, language: "Flow" });
  }
}, "convertSig");
var d = o((e) => {
  var _a2, _b, _c, _d;
  ...
  switch (typeof r < "u" && (n.raw = r), e.name) {
    ...
    case "signature":
      return { ...n, ...Pe(e) };
    case "union":
      return ((_a2 = e.elements) == null ? void 0 : _a2.every(he)) ? { ...n, name: "enum", value: (_b = e.elements) == null ? void 0 : _b.map(be) } : { ...n, name: t, value: (_c = e.elements) == null ? void 0 : _c.map(d) };
    case "intersection":
...
var ve = /^\(.*\) => /;
var x = o((e) => {
  let { name: t, raw: r, computed: n, value: s2 } = e, i = {};
  switch (typeof r < "u" && (i.raw = r), t) {
    case "enum": {
      let a = n ? s2 : s2.map((c) => h(c.value));
    ...
    case "arrayOf":
    case "array":
      return { ...i, name: "array", value: s2 && x(s2) };
    case "object":
      return { ...i, name: t };
    case "objectOf":
      return { ...i, name: t, value: x(s2) };
    case "shape":
    case "exact":
      let p = j(s2, (a) => x(a));
      return { ...i, name: "object", value: p };
    case "union":
      return { ...i, name: "union", value: s2.map((a) => x(a)) };
    case "instanceOf":
    case "element":
    case "elementType":
    default: {
      ...
      let a = s2 ? `${t}(${s2})` : t, c = ve.test(t) ? "function" : "other";
...
var Ee = o((e) => {
  switch (e.type) {
    ...
    default:
      throw new Z({ type: e, language: "Typescript" });
  }
}, "convertSig");
var D = o((e) => {
  var _a2, _b, _c, _d;
  ...
  switch (typeof r < "u" && (n.raw = r), e.name) {
    ...
    case "union":
      let s2;
      return ((_a2 = e.elements) == null ? void 0 : _a2.every((i) => i.name === "literal")) ? s2 = {
        ...n,
        name: "enum",
        // @ts-expect-error fix types
        value: (_b = e.elements) == null ? void 0 : _b.map((i) => h(i.value))
      } : s2 = { ...n, name: t, value: (_c = e.elements) == null ? void 0 : _c.map(D) }, s2;
    case "intersection":
      return { ...n, name: t, value: (_d = e.elements) == null ? void 0 : _d.map(D) };
    default:
      return { ...n, name: "other", value: t };
...
var je = ((s2) => (s2.JAVASCRIPT = "JavaScript", s2.FLOW = "Flow", s2.TYPESCRIPT = "TypeScript", s2.UNKNOWN = "Unknown", s2))(je || {});
...
function q(e) {
  return z(e) ? M2(e.__docgenInfo.description) : "";
}
...
var Fe = /^@\S+/;
function J({ fence: e = "```" } = {}) {
  let t = Je(e), r = o((n, s2) => t(n) ? !s2 : s2, "toggleFence");
  return o(function(s2) {
    let i = [[]], p = false;
    for (let a of s2)
...
function R({ tokenizers: e }) {
  return o(function(r) {
    ...
    let s2 = X({ source: r });
    for (let i of e)
      if (s2 = i(s2), !((n = s2.problems[s2.problems.length - 1]) === null || n === void 0) && n.critical)
        break;
    return s2;
  }, "parseSpec");
}
...
function S(e = "compact") {
  ...
  return (r) => {
    ...
    let i = [], p = s2[0][0].postDelimiter.length;
    for (let [a, [c, u]] of s2.entries())
...
function O() {
  ...
  return (t) => {
    let { tokens: r } = t.source[t.source.reduce(e, 0)], n = r.description.trimLeft(), s2 = n.split('"');
    if (s2.length > 1 && s2[0] === "" && s2.length % 2 === 1)
      return t.name = s2[1], r.name = `"${s2[1]}"`, [r.postName, r.description] = y(n.slice(r.name.length)), t;
    let i = 0, p = "", a = false, c;
    for (let m of n) {
      if (i === 0 && k(m))
        break;
...
o(Be, "preserveJoiner");
function V2({ startLine: e = 0, fence: t = "```", spacing: r = "compact", markers: n = f, tokenizers: s2 = [
  P(),
  S(r),
  O(),
  v(r)
  ...
  let i = N({ startLine: e, markers: n }), p = J({ fence: t }), a = R({ tokenizers: s2 }), c = A(r);
  return function(u) {
    let m = [];
    for (let ge of K(u)) {
      let E = i(ge);
      if (E === null)
        continue;
      let L2 = p(E), U = L2.slice(1).map(a);
      m.push({
        description: c(L2[0], n),
        tags: U,
        source: E,
    ...
    if (!(t !== void 0 && !t.includes(n.tag)))
      if (n.tag === "ignore") {
        ...
        switch (n.tag) {
          ...
          case "argument": {
            let s2 = Ke(n);
            s2 != null && (r.params == null && (r.params = []), r.params.push(s2));
            break;
          }
          case "deprecated": {
            let s2 = Xe(n);
            s2 != null && (r.deprecated = s2);
            break;
          }
          case "returns": {
            let s2 = He(n);
            s2 != null && (r.returns = s2);
            break;
          }
          default:
            break;
...
o(Ke, "extractParam");
function Xe(e) {
  return e.name ? Z2(e.name, e.description) : null;
}
...
function He(e) {
  ...
  return t ? {
    type: t,
    description: Z2(e.name, e.description),
...
o(ie, "createType");
var pe = o((e, t) => {
  let { flowType: r, description: n, required: s2, defaultValue: i } = t;
  return {
    name: e,
    type: ie(r),
    required: s2,
...
function ue(e, t, r) {
  let { description: n, required: s2, defaultValue: i } = r;
  return {
    name: e,
    type: nt(t),
    required: s2,
...
function w(e, t) {
  ...
  if (t == null ? void 0 : t.includesJsDoc) {
    ...
    let s2 = {
      ...n,
      params: (_a2 = n == null ? void 0 : n.params) == null ? void 0 : _a2.map(
        (i) => ({
    ...
    Object.values(s2).filter(Boolean).length > 0 && (e.jsDocTags = s2);
  }
  return e;
}
...
var mt = o((e) => {
  ...
  return e.map((n) => {
    var _a2;
    let s2 = n;
    return ((_a2 = n.type) == null ? void 0 : _a2.elements) && (s2 = {
      ...n,
      type: {
        ...n.type,
...
var ft = o((e) => {
  ...
  return t.map((s2) => {
    let i = e[s2];
    return i != null ? fe(s2, i, r, n) : null;
  }).filter(Boolean);
...
function fe(e, t, r, n) {
  let s2 = Q(t.description);
  return s2.includesJsDoc && s2.ignore ? null : {
    propDef: n(e, t, s2),
    jsDocTags: s2.extractedTags,
    docgenInfo: t,
    typeSystem: r
  };
}
...
var cn = o((e) => {
  let {
    ...
    argTypes: r,
    parameters: { docs: n = {} }
  } = e, { extractArgTypes: s2 } = n, i = s2 && t ? s2(t) : {};
  return i ? M(i, r) : r;
}, "enhanceArgTypes");
...
var dn = o((e) => {
  var _a2;
  return (_a2 = e.presetsList) == null ? void 0 : _a2.some((t) => dt.test(t.name));
}, "hasDocsOrControls");

// node_modules/@storybook/react/dist/chunk-EWIU6LHT.mjs
var React2 = __toESM(require_react(), 1);
var import_react2 = __toESM(require_react(), 1);
var require_react_is_production_min = __commonJS2({ "../../node_modules/react-is/cjs/react-is.production.min.js"(exports) {
  var b2 = typeof Symbol == "function" && Symbol.for, c = b2 ? Symbol.for("react.element") : 60103, d2 = b2 ? Symbol.for("react.portal") : 60106, e = b2 ? Symbol.for("react.fragment") : 60107, f2 = b2 ? Symbol.for("react.strict_mode") : 60108, g2 = b2 ? Symbol.for("react.profiler") : 60114, h2 = b2 ? Symbol.for("react.provider") : 60109, k2 = b2 ? Symbol.for("react.context") : 60110, l2 = b2 ? Symbol.for("react.async_mode") : 60111, m = b2 ? Symbol.for("react.concurrent_mode") : 60111, n = b2 ? Symbol.for("react.forward_ref") : 60112, p = b2 ? Symbol.for("react.suspense") : 60113, q2 = b2 ? Symbol.for("react.suspense_list") : 60120, r = b2 ? Symbol.for("react.memo") : 60115, t = b2 ? Symbol.for("react.lazy") : 60116, v2 = b2 ? Symbol.for("react.block") : 60121, w2 = b2 ? Symbol.for("react.fundamental") : 60117, x2 = b2 ? Symbol.for("react.responder") : 60118, y2 = b2 ? Symbol.for("react.scope") : 60119;
  function z2(a) {
  ...
  exports.isValidElementType = function(a) {
    return typeof a == "string" || typeof a == "function" || a === e || a === m || a === g2 || a === f2 || a === p || a === q2 || typeof a == "object" && a !== null && (a.$$typeof === t || a.$$typeof === r || a.$$typeof === h2 || a.$$typeof === k2 || a.$$typeof === n || a.$$typeof === w2 || a.$$typeof === x2 || a.$$typeof === y2 || a.$$typeof === v2);
  };
  exports.typeOf = z2;
} });
var require_react_is_development = __commonJS2({ "../../node_modules/react-is/cjs/react-is.development.js"(exports) {
  (function() {
    ...
    var AsyncMode = REACT_ASYNC_MODE_TYPE, ConcurrentMode = REACT_CONCURRENT_MODE_TYPE, ContextConsumer = REACT_CONTEXT_TYPE, ContextProvider = REACT_PROVIDER_TYPE, Element = REACT_ELEMENT_TYPE, ForwardRef2 = REACT_FORWARD_REF_TYPE, Fragment22 = REACT_FRAGMENT_TYPE, Lazy = REACT_LAZY_TYPE, Memo2 = REACT_MEMO_TYPE, Portal = REACT_PORTAL_TYPE, Profiler = REACT_PROFILER_TYPE, StrictMode2 = REACT_STRICT_MODE_TYPE, Suspense2 = REACT_SUSPENSE_TYPE, hasWarnedAboutDeprecatedIsAsyncMode = false;
    ...
    exports.AsyncMode = AsyncMode, exports.ConcurrentMode = ConcurrentMode, exports.ContextConsumer = ContextConsumer, exports.ContextProvider = ContextProvider, exports.Element = Element, exports.ForwardRef = ForwardRef2, exports.Fragment = Fragment22, exports.Lazy = Lazy, exports.Memo = Memo2, exports.Portal = Portal, exports.Profiler = Profiler, exports.StrictMode = StrictMode2, exports.Suspense = Suspense2, exports.isAsyncMode = isAsyncMode, exports.isConcurrentMode = isConcurrentMode, exports.isContextConsumer = isContextConsumer2, exports.isContextProvider = isContextProvider2, exports.isElement = isElement, exports.isForwardRef = isForwardRef3, exports.isFragment = isFragment, exports.isLazy = isLazy2, exports.isMemo = isMemo3, exports.isPortal = isPortal, exports.isProfiler = isProfiler2, exports.isStrictMode = isStrictMode2, exports.isSuspense = isSuspense2, exports.isValidElementType = isValidElementType, exports.typeOf = typeOf;
  })();
} });
var require_react_is = __commonJS2({ "../../node_modules/react-is/index.js"(exports, module2) {
  false ? module2.exports = require_react_is_production_min() : module2.exports = require_react_is_development();
} });
var require_object_assign = __commonJS2({ "../../node_modules/object-assign/index.js"(exports, module2) {
...
var require_ReactPropTypesSecret = __commonJS2({ "../../node_modules/prop-types/lib/ReactPropTypesSecret.js"(exports, module2) {
  var ReactPropTypesSecret = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";
  module2.exports = ReactPropTypesSecret;
} });
var require_has = __commonJS2({ "../../node_modules/prop-types/lib/has.js"(exports, module2) {
  module2.exports = Function.call.bind(Object.prototype.hasOwnProperty);
} });
var require_checkPropTypes = __commonJS2({ "../../node_modules/prop-types/checkPropTypes.js"(exports, module2) {
...
var require_factoryWithTypeCheckers = __commonJS2({ "../../node_modules/prop-types/factoryWithTypeCheckers.js"(exports, module2) {
...
var require_factoryWithThrowingShims = __commonJS2({ "../../node_modules/prop-types/factoryWithThrowingShims.js"(exports, module2) {
...
var require_prop_types = __commonJS2({ "../../node_modules/prop-types/index.js"(exports, module2) {
  true ? (ReactIs = require_react_is(), throwOnDirectAccess = true, module2.exports = require_factoryWithTypeCheckers()(ReactIs.isElement, throwOnDirectAccess)) : module2.exports = require_factoryWithThrowingShims()();
  var ReactIs, throwOnDirectAccess;
} });
var require_html_tags = __commonJS2({ "../../node_modules/html-tags/html-tags.json"(exports, module2) {
...
var require_html_tags2 = __commonJS2({ "../../node_modules/html-tags/index.js"(exports, module2) {
  module2.exports = require_html_tags();
} });
var require_estraverse = __commonJS2({ "../../node_modules/estraverse/estraverse.js"(exports) {
  (function clone(exports2) {
    ...
    Controller.prototype.path = function() {
      ...
      function addToPath(result2, path2) {
        if (Array.isArray(path2)) for (j2 = 0, jz = path2.length; j2 < jz; ++j2) result2.push(path2[j2]);
...
var require_ast = __commonJS2({ "../../node_modules/esutils/lib/ast.js"(exports, module2) {
  (function() {
...
var require_code = __commonJS2({ "../../node_modules/esutils/lib/code.js"(exports, module2) {
  (function() {
...
var require_keyword = __commonJS2({ "../../node_modules/esutils/lib/keyword.js"(exports, module2) {
  (function() {
...
var require_utils = __commonJS2({ "../../node_modules/esutils/lib/utils.js"(exports) {
  (function() {
    exports.ast = require_ast(), exports.code = require_code(), exports.keyword = require_keyword();
  })();
} });
var require_base64 = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/base64.js"(exports) {
...
var require_base64_vlq = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/base64-vlq.js"(exports) {
...
var require_util = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/util.js"(exports) {
  ...
  function isProtoString(s2) {
    ...
    if (length < 9 || s2.charCodeAt(length - 1) !== 95 || s2.charCodeAt(length - 2) !== 95 || s2.charCodeAt(length - 3) !== 111 || s2.charCodeAt(length - 4) !== 116 || s2.charCodeAt(length - 5) !== 111 || s2.charCodeAt(length - 6) !== 114 || s2.charCodeAt(length - 7) !== 112 || s2.charCodeAt(length - 8) !== 95 || s2.charCodeAt(length - 9) !== 95) return false;
    for (var i = length - 10; i >= 0; i--) if (s2.charCodeAt(i) !== 36) return false;
    return true;
  }
...
var require_array_set = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/array-set.js"(exports) {
...
var require_mapping_list = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/mapping-list.js"(exports) {
...
var require_source_map_generator = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/source-map-generator.js"(exports) {
...
var require_binary_search = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/binary-search.js"(exports) {
...
var require_quick_sort = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/quick-sort.js"(exports) {
  ...
  function doQuickSort(ary, comparator, p, r) {
    if (p < r) {
      ...
      for (var pivot = ary[r], j2 = p; j2 < r; j2++) comparator(ary[j2], pivot) <= 0 && (i += 1, swap(ary, i, j2));
      swap(ary, i + 1, j2);
      var q2 = i + 1;
      doQuickSort(ary, comparator, p, q2 - 1), doQuickSort(ary, comparator, q2 + 1, r);
    }
  }
...
var require_source_map_consumer = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js"(exports) {
  ...
  function BasicSourceMapConsumer(aSourceMap, aSourceMapURL) {
    ...
    var version22 = util.getArg(sourceMap, "version"), sources = util.getArg(sourceMap, "sources"), names = util.getArg(sourceMap, "names", []), sourceRoot = util.getArg(sourceMap, "sourceRoot", null), sourcesContent = util.getArg(sourceMap, "sourcesContent", null), mappings = util.getArg(sourceMap, "mappings"), file = util.getArg(sourceMap, "file", null);
    if (version22 != this._version) throw new Error("Unsupported version: " + version22);
    ...
    }), this._names = ArraySet.fromArray(names.map(String), true), this._sources = ArraySet.fromArray(sources, true), this._absoluteSources = this._sources.toArray().map(function(s2) {
  ...
  BasicSourceMapConsumer.fromSourceMap = function(aSourceMap, aSourceMapURL) {
    ...
    smc.sourceRoot = aSourceMap._sourceRoot, smc.sourcesContent = aSourceMap._generateSourcesContent(smc._sources.toArray(), smc.sourceRoot), smc.file = aSourceMap._file, smc._sourceMapURL = aSourceMapURL, smc._absoluteSources = smc._sources.toArray().map(function(s2) {
  ...
  function IndexedSourceMapConsumer(aSourceMap, aSourceMapURL) {
    var sourceMap = aSourceMap;
    typeof aSourceMap == "string" && (sourceMap = util.parseSourceMapInput(aSourceMap));
    var version22 = util.getArg(sourceMap, "version"), sections = util.getArg(sourceMap, "sections");
    if (version22 != this._version) throw new Error("Unsupported version: " + version22);
    this._sources = new ArraySet(), this._names = new ArraySet();
    var lastOffset = { line: -1, column: 0 };
    this._sections = sections.map(function(s2) {
      if (s2.url) throw new Error("Support for url field in sections not implemented.");
      var offset2 = util.getArg(s2, "offset"), offsetLine = util.getArg(offset2, "line"), offsetColumn = util.getArg(offset2, "column");
      if (offsetLine < lastOffset.line || offsetLine === lastOffset.line && offsetColumn < lastOffset.column) throw new Error("Section offsets must be ordered and non-overlapping.");
      return lastOffset = offset2, { generatedOffset: { generatedLine: offsetLine + 1, generatedColumn: offsetColumn + 1 }, consumer: new SourceMapConsumer(util.getArg(s2, "map"), aSourceMapURL) };
    });
  }
  ...
  Object.defineProperty(IndexedSourceMapConsumer.prototype, "sources", { get: function() {
    for (var sources = [], i = 0; i < this._sections.length; i++) for (var j2 = 0; j2 < this._sections[i].consumer.sources.length; j2++) sources.push(this._sections[i].consumer.sources[j2]);
    return sources;
  } });
  ...
  IndexedSourceMapConsumer.prototype._parseMappings = function(aStr, aSourceRoot) {
    ...
    for (var i = 0; i < this._sections.length; i++) for (var section = this._sections[i], sectionMappings = section.consumer._generatedMappings, j2 = 0; j2 < sectionMappings.length; j2++) {
...
var require_source_node = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/lib/source-node.js"(exports) {
...
var require_source_map = __commonJS2({ "../../node_modules/escodegen/node_modules/source-map/source-map.js"(exports) {
  exports.SourceMapGenerator = require_source_map_generator().SourceMapGenerator;
  exports.SourceMapConsumer = require_source_map_consumer().SourceMapConsumer;
  exports.SourceNode = require_source_node().SourceNode;
} });
var require_package = __commonJS2({ "../../node_modules/escodegen/package.json"(exports, module2) {
...
var require_escodegen = __commonJS2({ "../../node_modules/escodegen/escodegen.js"(exports) {
  (function() {
...
`, space: " ", json: false, renumber: false, hexadecimal: false, quotes: "single", escapeless: false, compact: false, parentheses: true, semicolons: true, safeConcatenation: false, preserveBlankLines: false }, moz: { comprehensionExpressionStartsWithAssignment: false, starlessGenerator: false }, sourceMap: null, sourceMapRoot: null, sourceMapWithCode: false, directive: false, raw: true, verbatim: null, sourceCode: null };
    ...
    function adjustMultilineComment(value, specialBase) {
      var array, i, len, line, j2, spaces, previousBase, sn;
      for (array = value.split(/\r\n|[\r\n]/), spaces = Number.MAX_VALUE, i = 1, len = array.length; i < len; ++i) {
        for (line = array[i], j2 = 0; j2 < line.length && esutils.code.isWhiteSpace(line.charCodeAt(j2)); ) ++j2;
        spaces > j2 && (spaces = j2);
      }
...
`]);
    ...
    function generateBlankLines(start, end, result) {
      ...
      for (j2 = start; j2 < end; j2++) sourceCode[j2] === `
` && newlineCount++;
      for (j2 = 1; j2 < newlineCount; j2++) result.push(newline);
    }
...
var acorn_exports = {};
__export(acorn_exports, { Node: () => Node, Parser: () => Parser, Position: () => Position, SourceLocation: () => SourceLocation, TokContext: () => TokContext, Token: () => Token, TokenType: () => TokenType, defaultOptions: () => defaultOptions, getLineInfo: () => getLineInfo, isIdentifierChar: () => isIdentifierChar, isIdentifierStart: () => isIdentifierStart, isNewLine: () => isNewLine, keywordTypes: () => keywords$1, lineBreak: () => lineBreak, lineBreakG: () => lineBreakG, nonASCIIwhitespace: () => nonASCIIwhitespace, parse: () => parse3, parseExpressionAt: () => parseExpressionAt2, tokContexts: () => types$1, tokTypes: () => types, tokenizer: () => tokenizer2, version: () => version2 });
...
function buildUnicodeData(ecmaVersion) {
  var d2 = data[ecmaVersion] = { binary: wordsRegexp(unicodeBinaryProperties[ecmaVersion] + " " + unicodeGeneralCategoryValues), nonBinary: { General_Category: wordsRegexp(unicodeGeneralCategoryValues), Script: wordsRegexp(unicodeScriptValues[ecmaVersion]) } };
...
var init_acorn = __esm({ "../../node_modules/acorn/dist/acorn.mjs"() {
  ...
  BIND_NONE = 0, BIND_VAR = 1, BIND_LEXICAL = 2, BIND_FUNCTION = 3, BIND_SIMPLE_CATCH = 4, BIND_OUTSIDE = 5, Parser = function(options, input, startPos) {
    ...
    if (options.allowReserved !== true) {
      for (var v2 = options.ecmaVersion; !(reserved = reservedWords[v2]); v2--) ;
...
`), cooked: this.value }, this.next(), elem.tail = this.type === types.backQuote, this.finishNode(elem, "TemplateElement");
  ...
  pp$3.checkUnreserved = function(ref2) {
    ...
    if (this.inGenerator && name === "yield" && this.raiseRecoverable(start, "Cannot use 'yield' as identifier inside a generator"), this.inAsync && name === "await" && this.raiseRecoverable(start, "Cannot use 'await' as identifier inside an async function"), this.keywords.test(name) && this.raise(start, "Unexpected keyword '" + name + "'"), !(this.options.ecmaVersion < 6 && this.input.slice(start, end).indexOf("\\") !== -1)) {
      ...
      re2.test(name) && (!this.inAsync && name === "await" && this.raiseRecoverable(start, "Cannot use keyword 'await' outside an async function"), this.raiseRecoverable(start, "The keyword '" + name + "' is reserved"));
    }
  };
  ...
  pp$5.currentVarScope = function() {
    for (var i = this.scopeStack.length - 1; ; i--) {
      ...
      if (scope2.flags & SCOPE_VAR) return scope2;
    }
  };
  pp$5.currentThisScope = function() {
    for (var i = this.scopeStack.length - 1; ; i--) {
      var scope2 = this.scopeStack[i];
      if (scope2.flags & SCOPE_VAR && !(scope2.flags & SCOPE_ARROW)) return scope2;
    }
  };
  ...
  RegExpValidationState.prototype.nextIndex = function(i, forceU) {
    ...
    return !(forceU || this.switchU) || c <= 55295 || c >= 57344 || i + 1 >= l2 || (next = s2.charCodeAt(i + 1)) < 56320 || next > 57343 ? i + 1 : i + 2;
  };
...
`;
  ...
  version2 = "7.4.1";
  Parser.acorn = { Parser, version: version2, defaultOptions, Position, SourceLocation, getLineInfo, Node, TokenType, tokTypes: types, keywordTypes: keywords$1, TokContext, tokContexts: types$1, isIdentifierChar, isIdentifierStart, Token, isNewLine, lineBreak, lineBreakG, nonASCIIwhitespace };
} });
var require_xhtml = __commonJS2({ "../../node_modules/acorn-jsx/xhtml.js"(exports, module2) {
...
`) : out = String.fromCharCode(ch), this.options.locations && (++this.curLine, this.lineStart = this.pos), out;
      ...
      jsx_readString(quote) {
        ...
        return out += this.input.slice(chunkStart, this.pos++), this.finishToken(tt2.string, out);
      }
      jsx_readEntity() {
      ...
      jsx_parseElementName() {
        ...
        for (this.type === tt2.dot && node.type === "JSXNamespacedName" && !options.allowNamespacedObjects && this.unexpected(); this.eat(tt2.dot); ) {
      ...
      jsx_parseExpressionContainer() {
        let node = this.startNode();
        return this.next(), node.expression = this.type === tt2.braceR ? this.jsx_parseEmptyExpression() : this.parseExpression(), this.expect(tt2.braceR), this.finishNode(node, "JSXExpressionContainer");
      }
      jsx_parseAttribute() {
        let node = this.startNode();
        return this.eat(tt2.braceL) ? (this.expect(tt2.ellipsis), node.argument = this.parseMaybeAssign(), this.expect(tt2.braceR), this.finishNode(node, "JSXSpreadAttribute")) : (node.name = this.jsx_parseNamespacedName(), node.value = this.eat(tt2.eq) ? this.jsx_parseAttributeValue() : null, this.finishNode(node, "JSXAttribute"));
      }
      jsx_parseOpeningElementAt(startPos, startLoc) {
        let node = this.startNodeAt(startPos, startLoc);
        node.attributes = [];
        let nodeName = this.jsx_parseElementName();
        for (nodeName && (node.name = nodeName); this.type !== tt2.slash && this.type !== tok.jsxTagEnd; ) node.attributes.push(this.jsx_parseAttribute());
        return node.selfClosing = this.eat(tt2.slash), this.expect(tok.jsxTagEnd), this.finishNode(node, nodeName ? "JSXOpeningElement" : "JSXOpeningFragment");
      }
      ...
      jsx_parseElementAt(startPos, startLoc) {
        ...
        if (!openingElement.selfClosing) {
          contents: for (; ; ) switch (this.type) {
            case tok.jsxTagStart:
              if (startPos = this.start, startLoc = this.startLoc, this.next(), this.eat(tt2.slash)) {
        ...
        return node["opening" + fragmentOrElement] = openingElement, node["closing" + fragmentOrElement] = closingElement, node.children = children, this.type === tt2.relational && this.value === "<" && this.raise(this.start, "Adjacent JSX elements must be wrapped in an enclosing tag"), this.finishNode(node, "JSX" + fragmentOrElement);
      }
      jsx_parseText() {
      ...
      updateContext(prevType) {
        ...
        } else if (this.type === tt2.slash && prevType === tok.jsxTagStart) this.context.length -= 2, this.context.push(tc_cTag), this.exprAllowed = false;
        else return super.updateContext(prevType);
      }
    };
  }
} });
var require_dist2 = __commonJS2({ "../../node_modules/@base2/pretty-print-object/dist/index.js"(exports) {
  var __assign = exports && exports.__assign || function() {
    ...
    for (var r = Array(s2), k2 = 0, i = 0; i < il; i++) for (var a = arguments[i], j2 = 0, jl = a.length; j2 < jl; j2++, k2++) r[k2] = a[j2];
    return r;
  };
...
var require_react_is_production_min2 = __commonJS2({ "../../node_modules/react-element-to-jsx-string/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
  ...
  exports.isValidElementType = function(a) {
    return typeof a == "string" || typeof a == "function" || a === d2 || a === f2 || a === e || a === m || a === n || a === t || typeof a == "object" && a !== null && (a.$$typeof === q2 || a.$$typeof === p || a.$$typeof === g2 || a.$$typeof === h2 || a.$$typeof === l2 || a.$$typeof === u || a.getModuleId !== void 0);
  };
  exports.typeOf = v2;
} });
var require_react_is_development2 = __commonJS2({ "../../node_modules/react-element-to-jsx-string/node_modules/react-is/cjs/react-is.development.js"(exports) {
  (function() {
...
var require_react_is2 = __commonJS2({ "../../node_modules/react-element-to-jsx-string/node_modules/react-is/index.js"(exports, module2) {
  false ? module2.exports = require_react_is_production_min2() : module2.exports = require_react_is_development2();
} });
var entry_preview_docs_exports = {};
__export(entry_preview_docs_exports, { applyDecorators: () => applyDecorators, argTypesEnhancers: () => argTypesEnhancers, decorators: () => decorators2, parameters: () => parameters2 });
...
function simple(node, visitors, baseVisitor, state, override) {
  baseVisitor || (baseVisitor = base), function c(node2, st2, override2) {
    var type = override2 || node2.type, found = visitors[type];
    baseVisitor[type](node2, st2, c), found && found(node2, st2);
  }(node, state, override);
}
function ancestor(node, visitors, baseVisitor, state, override) {
  ...
  baseVisitor || (baseVisitor = base), function c(node2, st2, override2) {
    ...
    isNew && ancestors.push(node2), baseVisitor[type](node2, st2, c), found && found(node2, st2 || ancestors, ancestors), isNew && ancestors.pop();
  }(node, state, override);
}
...
var base = {};
base.Program = base.BlockStatement = function(node, st2, c) {
  for (var i = 0, list = node.body; i < list.length; i += 1) {
    var stmt = list[i];
    c(stmt, st2, "Statement");
  }
};
base.Statement = skipThrough;
base.EmptyStatement = ignore;
base.ExpressionStatement = base.ParenthesizedExpression = base.ChainExpression = function(node, st2, c) {
  return c(node.expression, st2, "Expression");
};
base.IfStatement = function(node, st2, c) {
  c(node.test, st2, "Expression"), c(node.consequent, st2, "Statement"), node.alternate && c(node.alternate, st2, "Statement");
};
base.LabeledStatement = function(node, st2, c) {
  return c(node.body, st2, "Statement");
};
base.BreakStatement = base.ContinueStatement = ignore;
base.WithStatement = function(node, st2, c) {
  c(node.object, st2, "Expression"), c(node.body, st2, "Statement");
};
base.SwitchStatement = function(node, st2, c) {
  c(node.discriminant, st2, "Expression");
  for (var i$1 = 0, list$1 = node.cases; i$1 < list$1.length; i$1 += 1) {
    var cs = list$1[i$1];
    cs.test && c(cs.test, st2, "Expression");
    for (var i = 0, list = cs.consequent; i < list.length; i += 1) {
      var cons = list[i];
      c(cons, st2, "Statement");
    }
  }
};
base.SwitchCase = function(node, st2, c) {
  node.test && c(node.test, st2, "Expression");
  for (var i = 0, list = node.consequent; i < list.length; i += 1) {
    var cons = list[i];
    c(cons, st2, "Statement");
  }
};
base.ReturnStatement = base.YieldExpression = base.AwaitExpression = function(node, st2, c) {
  node.argument && c(node.argument, st2, "Expression");
};
base.ThrowStatement = base.SpreadElement = function(node, st2, c) {
  return c(node.argument, st2, "Expression");
};
base.TryStatement = function(node, st2, c) {
  c(node.block, st2, "Statement"), node.handler && c(node.handler, st2), node.finalizer && c(node.finalizer, st2, "Statement");
};
base.CatchClause = function(node, st2, c) {
  node.param && c(node.param, st2, "Pattern"), c(node.body, st2, "Statement");
};
base.WhileStatement = base.DoWhileStatement = function(node, st2, c) {
  c(node.test, st2, "Expression"), c(node.body, st2, "Statement");
};
base.ForStatement = function(node, st2, c) {
  node.init && c(node.init, st2, "ForInit"), node.test && c(node.test, st2, "Expression"), node.update && c(node.update, st2, "Expression"), c(node.body, st2, "Statement");
};
base.ForInStatement = base.ForOfStatement = function(node, st2, c) {
  c(node.left, st2, "ForInit"), c(node.right, st2, "Expression"), c(node.body, st2, "Statement");
};
base.ForInit = function(node, st2, c) {
  node.type === "VariableDeclaration" ? c(node, st2) : c(node, st2, "Expression");
};
base.DebuggerStatement = ignore;
base.FunctionDeclaration = function(node, st2, c) {
  return c(node, st2, "Function");
};
base.VariableDeclaration = function(node, st2, c) {
  for (var i = 0, list = node.declarations; i < list.length; i += 1) {
    var decl = list[i];
    c(decl, st2);
  }
};
base.VariableDeclarator = function(node, st2, c) {
  c(node.id, st2, "Pattern"), node.init && c(node.init, st2, "Expression");
};
base.Function = function(node, st2, c) {
  node.id && c(node.id, st2, "Pattern");
  for (var i = 0, list = node.params; i < list.length; i += 1) {
    var param = list[i];
    c(param, st2, "Pattern");
  }
  c(node.body, st2, node.expression ? "Expression" : "Statement");
};
base.Pattern = function(node, st2, c) {
  node.type === "Identifier" ? c(node, st2, "VariablePattern") : node.type === "MemberExpression" ? c(node, st2, "MemberPattern") : c(node, st2);
};
base.VariablePattern = ignore;
base.MemberPattern = skipThrough;
base.RestElement = function(node, st2, c) {
  return c(node.argument, st2, "Pattern");
};
base.ArrayPattern = function(node, st2, c) {
  for (var i = 0, list = node.elements; i < list.length; i += 1) {
    var elt = list[i];
    elt && c(elt, st2, "Pattern");
  }
};
base.ObjectPattern = function(node, st2, c) {
  for (var i = 0, list = node.properties; i < list.length; i += 1) {
    var prop = list[i];
    prop.type === "Property" ? (prop.computed && c(prop.key, st2, "Expression"), c(prop.value, st2, "Pattern")) : prop.type === "RestElement" && c(prop.argument, st2, "Pattern");
  }
};
base.Expression = skipThrough;
base.ThisExpression = base.Super = base.MetaProperty = ignore;
base.ArrayExpression = function(node, st2, c) {
  for (var i = 0, list = node.elements; i < list.length; i += 1) {
    var elt = list[i];
    elt && c(elt, st2, "Expression");
  }
};
base.ObjectExpression = function(node, st2, c) {
  for (var i = 0, list = node.properties; i < list.length; i += 1) {
    var prop = list[i];
    c(prop, st2);
  }
...
base.SequenceExpression = function(node, st2, c) {
  for (var i = 0, list = node.expressions; i < list.length; i += 1) {
    var expr = list[i];
    c(expr, st2, "Expression");
  }
};
base.TemplateLiteral = function(node, st2, c) {
...
base.UnaryExpression = base.UpdateExpression = function(node, st2, c) {
  c(node.argument, st2, "Expression");
};
base.BinaryExpression = base.LogicalExpression = function(node, st2, c) {
  c(node.left, st2, "Expression"), c(node.right, st2, "Expression");
};
base.AssignmentExpression = base.AssignmentPattern = function(node, st2, c) {
  c(node.left, st2, "Pattern"), c(node.right, st2, "Expression");
};
base.ConditionalExpression = function(node, st2, c) {
  c(node.test, st2, "Expression"), c(node.consequent, st2, "Expression"), c(node.alternate, st2, "Expression");
};
base.NewExpression = base.CallExpression = function(node, st2, c) {
  if (c(node.callee, st2, "Expression"), node.arguments) for (var i = 0, list = node.arguments; i < list.length; i += 1) {
    var arg = list[i];
    c(arg, st2, "Expression");
  }
};
base.MemberExpression = function(node, st2, c) {
  c(node.object, st2, "Expression"), node.computed && c(node.property, st2, "Expression");
};
base.ExportNamedDeclaration = base.ExportDefaultDeclaration = function(node, st2, c) {
  node.declaration && c(node.declaration, st2, node.type === "ExportNamedDeclaration" || node.declaration.id ? "Statement" : "Expression"), node.source && c(node.source, st2, "Expression");
};
base.ExportAllDeclaration = function(node, st2, c) {
  node.exported && c(node.exported, st2), c(node.source, st2, "Expression");
};
...
base.TaggedTemplateExpression = function(node, st2, c) {
  c(node.tag, st2, "Expression"), c(node.quasi, st2, "Expression");
};
base.ClassDeclaration = base.ClassExpression = function(node, st2, c) {
  return c(node, st2, "Class");
};
base.Class = function(node, st2, c) {
  node.id && c(node.id, st2, "Pattern"), node.superClass && c(node.superClass, st2, "Expression"), c(node.body, st2);
};
base.ClassBody = function(node, st2, c) {
  for (var i = 0, list = node.body; i < list.length; i += 1) {
    var elt = list[i];
    c(elt, st2);
  }
};
base.MethodDefinition = base.Property = function(node, st2, c) {
  node.computed && c(node.key, st2, "Expression"), c(node.value, st2, "Expression");
};
...
var import_pretty_print_object = __toESM2(require_dist2());
...
function _unsupportedIterableToArray(o2, minLen) {
  if (o2) {
    ...
    if (n === "Object" && o2.constructor && (n = o2.constructor.name), n === "Map" || n === "Set") return Array.from(o2);
...
function safeSortObject(value, seen) {
  return value === null || _typeof(value) !== "object" || value instanceof Date || value instanceof RegExp || React2.isValidElement(value) ? value : (seen.add(value), Array.isArray(value) ? value.map(function(v2) {
...
var supportFragment = !!import_react2.Fragment;
...
var getWrappedComponentDisplayName = function getWrappedComponentDisplayName2(Component2) {
  switch (true) {
    case !!Component2.displayName:
      return Component2.displayName;
    case Component2.$$typeof === import_react_is.Memo:
      return getWrappedComponentDisplayName2(Component2.type);
    case Component2.$$typeof === import_react_is.ForwardRef:
      return getWrappedComponentDisplayName2(Component2.render);
    default:
      return getFunctionTypeName(Component2);
  }
};
...
var parseReactElement = function parseReactElement2(element, options) {
  ...
  if (!import_react2.default.isValidElement(element)) throw new Error("react-element-to-jsx-string: Expected a React.Element, got `".concat(_typeof(element), "`"));
  ...
  var defaultProps = filterProps(element.type.defaultProps || {}, noChildren), childrens = import_react2.default.Children.toArray(element.props.children).filter(onlyMeaningfulChildren).map(function(child) {
    return parseReactElement2(child, options);
  });
  return supportFragment && element.type === import_react2.Fragment ? createReactFragmentTreeNode(key, childrens) : createReactElementTreeNode(displayName, props, defaultProps, childrens);
};
function noRefCheck() {
}
...
var formatComplexDataStructure = function(value, inline, lvl, options) {
  var normalizedValue = sortObject(value), stringifiedValue = (0, import_pretty_print_object.prettyPrint)(normalizedValue, { transform: function(currentObj, prop, originalResult) {
    ...
    return currentValue && (0, import_react2.isValidElement)(currentValue) ? formatTreeNode(parseReactElement(currentValue, options), true, lvl, options) : typeof currentValue == "function" ? formatFunction(currentValue, options) : originalResult;
  } });
...
var formatPropValue = function(propValue, inline, lvl, options) {
  ...
  return typeof propValue == "function" ? "{".concat(formatFunction(propValue, options), "}") : (0, import_react2.isValidElement)(propValue) ? "{".concat(formatTreeNode(parseReactElement(propValue, options), true, lvl, options), "}") : propValue instanceof Date ? isNaN(propValue.valueOf()) ? "{new Date(NaN)}" : '{new Date("'.concat(propValue.toISOString(), '")}') : isPlainObject2(propValue) || Array.isArray(propValue) ? "{".concat(formatComplexDataStructure(propValue, inline, lvl, options), "}") : "{".concat(String(propValue), "}");
};
...
var jsxStopChars = ["<", ">", "{", "}"];
var shouldBeEscaped = function(s2) {
  return jsxStopChars.some(function(jsxStopChar) {
    return s2.includes(jsxStopChar);
  });
};
var escape2 = function(s2) {
  return shouldBeEscaped(s2) ? "{`".concat(s2, "`}") : s2;
};
var preserveTrailingSpace = function(s2) {
  var result = s2;
...
function generateUnion(type, extractedProp) {
  if (Array.isArray(type.value)) {
    ...
    return createTypeDef({ name: "union", short: values.short.join(" | "), compact: values.compact.every((x2) => x2 != null) ? values.compact.join(" | ") : null, full: values.full.join(" | ") });
  }
...
function generateEnum(type) {
  if (Array.isArray(type.value)) {
    ...
    return createTypeDef({ name: "enum", short: values.short.join(" | "), compact: values.compact.every((x2) => x2 != null) ? values.compact.join(" | ") : null, full: values.full.join(" | ") });
  }
...
function enhancePropTypesProps(extractedProps, component) {
  let rawDefaultProps = component.defaultProps != null ? component.defaultProps : {}, enhancedProps = extractedProps.map((x2) => enhancePropTypesProp(x2, rawDefaultProps[x2.propDef.name]));
...
var renderJsx = (code, options) => {
  if (typeof code > "u") return s.warn("Too many skip or undefined component"), null;
  let renderedJSX = code, Type = renderedJSX.type;
  for (let i = 0; i < (options == null ? void 0 : options.skip); i += 1) {
    if (typeof renderedJSX > "u") return s.warn("Cannot skip undefined element"), null;
    if (import_react2.default.Children.count(renderedJSX) > 1) return s.warn("Trying to skip an array of elements"), null;
    typeof renderedJSX.props.children > "u" ? (s.warn("Not enough children to skip elements."), typeof renderedJSX.type == "function" && renderedJSX.type.name === "" && (renderedJSX = import_react2.default.createElement(Type, { ...renderedJSX.props }))) : typeof renderedJSX.props.children == "function" ? renderedJSX = renderedJSX.props.children() : renderedJSX = renderedJSX.props.children;
  }
  ...
  typeof (options == null ? void 0 : options.displayName) == "string" ? displayNameDefaults = { showFunctions: true, displayName: () => options.displayName } : displayNameDefaults = { displayName: (el) => {
    var _a2;
    return el.type.displayName ? el.type.displayName : Y(el.type, "displayName") ? Y(el.type, "displayName") : ((_a2 = el.type.render) == null ? void 0 : _a2.displayName) ? el.type.render.displayName : typeof el.type == "symbol" || el.type.$$typeof && typeof el.type.$$typeof == "symbol" ? getReactSymbolName(el.type) : el.type.name && el.type.name !== "_default" ? el.type.name : typeof el.type == "function" ? "No Display Name" : isForwardRef(el.type) ? el.type.render.name : isMemo(el.type) ? el.type.type.name : el.type;
  } };
...
var isMdx = (node) => {
  var _a2, _b;
  return ((_a2 = node.type) == null ? void 0 : _a2.displayName) === "MDXCreateElement" && !!((_b = node.props) == null ? void 0 : _b.mdxType);
};
var mdxToJsx = (node) => {
...
var jsxDecorator = (storyFn, context) => {
  var _a2, _b;
  let channel = V.getChannel(), skip = skipJsxRender(context), jsx2 = "";
  jt(() => {
    if (!skip) {
  ...
  let options = { ...defaultOpts, ...(context == null ? void 0 : context.parameters.jsx) || {} }, storyJsx = ((_b = (_a2 = context == null ? void 0 : context.parameters.docs) == null ? void 0 : _a2.source) == null ? void 0 : _b.excludeDecorators) ? context.originalStoryFn(context.args, context) : story, sourceJsx = mdxToJsx(storyJsx), rendered = renderJsx(sourceJsx, options);
  return rendered && (jsx2 = rendered), story;
};
var applyDecorators = (storyFn, decorators22) => {
  let jsxIndex = decorators22.findIndex((d2) => d2.originalFn === jsxDecorator), reorderedDecorators = jsxIndex === -1 ? decorators22 : [...decorators22.splice(jsxIndex, 1), ...decorators22];
  return Hr(storyFn, reorderedDecorators);
};
var parameters2 = { docs: { story: { inline: true }, extractArgTypes, extractComponentDescription: nn } };
var decorators2 = [jsxDecorator];
...
function setProjectAnnotations(projectAnnotations) {
  return $s(INTERNAL_DEFAULT_PROJECT_ANNOTATIONS), Js(projectAnnotations);
}
var INTERNAL_DEFAULT_PROJECT_ANNOTATIONS = { ...entry_preview_exports, renderToCanvas: async (renderContext, canvasElement) => {
  ...
  let { storyContext: { context, unboundStoryFn: Story, testingLibraryRender: render2 } } = renderContext, { unmount } = render2(React.createElement(Story, { ...context }), { container: context.canvasElement });
  return unmount;
} };
function composeStory(story, componentAnnotations, projectAnnotations, exportsName) {
  return Ro(story, componentAnnotations, projectAnnotations, globalThis.globalProjectAnnotations ?? INTERNAL_DEFAULT_PROJECT_ANNOTATIONS, exportsName);
}
function composeStories(csfExports, projectAnnotations) {
  return Zs(csfExports, projectAnnotations, composeStory);
}
var _a;
