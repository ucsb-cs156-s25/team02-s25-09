  ...
  describe("tests where backend is working normally", () => {
    ...
    beforeEach(() => {
      ...
      axiosMock.onGet("/api/articles", { params: { id: 17 } }).reply(200, {
        ...
        explanation: "This is a sample article for testing",
      ...
      axiosMock.onPut("/api/articles").reply(200, {
        ...
        explanation: "This is an updated article for testing",
        email: "test@example.com",
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(urlField).toHaveValue("https://example.com/article");
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(urlField, {
        target: { value: "https://example.com/updated-article" },
      });
      fireEvent.change(explanationField, {
        target: { value: "This is an updated article for testing" },
      });
