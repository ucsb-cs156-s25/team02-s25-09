...
describe("UCSBDiningCommonsMenuItemCreatePage tests", () => {
  ...
  test("on submit, makes request to backend, and redirects to /ucsbdiningcommonsmenuitem", async () => {
    ...
    fireEvent.change(nameInput, { target: { value: "sandwich" } });
    fireEvent.change(stationInput, { target: { value: "sandwich bar" } });
    ...
    expect(mockToast).toHaveBeenCalledWith(
      "New item Created - id: 7 diningCommonsCode: portola",
    );
